...
NEXT:
    ...
    dropdown_show_tray_icon.selected = dropdown_show_tray_icon.over = save->show_tray_icon;
    ...
    show_tray_icon = save->show_tray_icon;
...
void config_save(UTOX_SAVE *save)
{
    ...
    save->show_tray_icon = show_tray_icon;
